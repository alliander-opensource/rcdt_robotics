...
namespace_arg = LaunchArgument("namespace", "lynx")


def launch_setup(context: LaunchContext) -> list:
    """Setup the launch description for the Lynx controllers.
...
def generate_launch_description() -> LaunchDescription:
    """Generate the launch description for the Lynx controllers.

    Returns:
        LaunchDescription: The launch description containing the Lynx controllers.
    """
