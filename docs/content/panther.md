...
**ZED 2i:**
\
To use the ZED 2i camera, ssh into the *ThinkStation*. Here you can find the cloned [zed-docker](https://github.com/husarion/zed-docker) repository folder. One can start the docker with these commands:
...
It also bears mentioning that [Husarion provides a webui](https://husarion.com/manuals/panther/software/ros2/robot-management/#webui), but this appears to be poorly-maintained. Additionally, it requires snap packages, which are tricky to install in a dockerized environment.  
