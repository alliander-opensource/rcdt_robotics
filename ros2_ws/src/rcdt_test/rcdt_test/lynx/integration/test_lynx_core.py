...
def lynx_core_launch(request: SubRequest) -> LaunchDescription:
    """Fixture to create launch file for lynx core and controllers.

    Args:
        request (SubRequest): The pytest request object, used to access command line options

    Returns:
        LaunchDescription: The launch description for the lynx core and controllers.
    """
...
@pytest.mark.launch(fixture=lynx_core_launch)
def test_wait_for_register(timeout: int) -> None:
    """Test that the Lynx core is registered in the RCDT.

    Args:
        timeout (int): The timeout in seconds to wait for the Lynx core to register.
    """
